...
import EvictionAllotment from "../../components/Popover/EvictionAllotment";
import {
...
export default function AllotmentLead() {
  ...
  const onSubmit = async values => {
    ...
    const groupTotal = _.sum(filterValues.map(item => item.percentage));
    ...
    <div className="page-content">
      <Container fluid>
        <form onSubmit={handleSubmit(onSubmit)}>
          <HeaderCreateItem title="Cấu hình Phân bổ tự động">
                ...
                selectedAllotmentTeamAEmployee === "employee" && (
                  <Popover
                    ...
                    content={
                      <EvictionAllotment
                        option={employee}
                        teamId={selectedEmployee.objectId}
                        handleOpen={setIsOpenPopover}
                        updateList={getValues()}
                      />
                    }
                    placement="bottom"
                    trigger="click"
