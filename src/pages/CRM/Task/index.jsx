...
import TaskManagementKanban from "components/Projects/task/Management";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          ...
          >
            <h4 style={{ margin: "0" }}>Quản lý công việc</h4>
          </div>
          <div
            className="d-flex align-items-center"
            style={{
          ...
          {enableKanbanView ? (
            ...
            <VVSTable title="" name="Task" disableAdd disableDelete />
          )}
        </Container>
      </div>
    </React.Fragment>
